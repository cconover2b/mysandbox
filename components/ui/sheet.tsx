...
>(({ className, ...props }, ref) => {
  console.log('SheetOverlay props:', props) // Log props
  return (
...
>(({ side = "right", className, children, ...props }, ref) => {
  console.log('SheetContent props:', props) // Log props
  return (
    <SheetPortal>
      <SheetOverlay />
...
const SheetHeader = ({
  ...
  console.log('SheetHeader props:', props) // Log props
  return (
    <div
      className={cn(
...
const SheetFooter = ({
  ...
  console.log('SheetFooter props:', props) // Log props
  return (
    <div
      className={cn(
...
>(({ className, ...props }, ref) => {
  console.log('SheetTitle props:', props) // Log props
  return (
...
>(({ className, ...props }, ref) => {
  console.log('SheetDescription props:', props) // Log props
  return (
